...
- virheilmoitusta tulisi muuttaa selkokielisemmäksi (test\_pics / rekisteroityminen PNG)
    - [x] v0.0.3-189-g3b4fa04
...
- onnistui, mutta...
- ensimmäisellä kerralla saatiin outo näkymä, eikä vaihto toiminut (test\_pics / salasanan\_palautus PNG)
...
- virheilmoitusta tulisi muuttaa selkokielisemmäksi (test\_pics / taidon\_arvojen\_validointi PNG)

### 2.4 Taidon arvojen muokkaaminen oikeellisilla syötteillä
- epäonnistui
- kokemuksen arvon validointi on virheellinen. maksimiarvoksi on asetettu 5(kk) (test\_pics / taidon\_arvojen\_validointi2 PNG)
- virheilmoitus ei katoa, vaikka arvon muuttaa validiksi ja tallentaa tiedot (test\_pics / taidon\_arvojen\_validointi3 PNG)
